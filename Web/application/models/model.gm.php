<?php
    ...
    class Mgm extends model
    {
        ...
        public static function valid_username($name, $symbols = '\w+', $len = [3, 30])
        {
        ...
        {
            $stmt = $this->website->db('web')->prepare('SELECT name, type, server, time, is_permanent FROM DmN_Ban_List  WHERE server = :server ORDER BY time ASC, is_permanent ASC');
