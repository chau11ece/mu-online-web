...
// ================================================================================================
// Email Settings (PHPMailer - Resend/SendGrid/SMTP)
// ================================================================================================
// Check if email is enabled - support both boolean and string "true"
$email_env = getenv('EMAIL_ENABLED');
$option['email_enabled']     = ($email_env === true || $email_env === 'true' || $email_env === '1' || $email_env === 1);
$option['email_host']        = getenv('EMAIL_HOST') ?: 'smtp.resend.com';
$option['email_port']        = getenv('EMAIL_PORT') ?: '587';
$option['email_username']    = getenv('EMAIL_USERNAME') ?: '';
$option['email_password']    = getenv('EMAIL_PASSWORD') ?: '';
$option['email_api_key']     = getenv('EMAIL_API_KEY') ?: ''; // For Resend/SendGrid
$option['email_from']        = getenv('EMAIL_FROM') ?: 'noreply@muonline.com';
$option['email_from_name']   = getenv('EMAIL_FROM_NAME') ?: 'MU Online Server';
$option['email_secure']      = getenv('EMAIL_SECURE') ?: 'tls'; // tls or ssl
