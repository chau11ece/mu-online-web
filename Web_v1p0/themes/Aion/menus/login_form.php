...
<div class="login_form">
   <form name="'.form_enc().'" method="post" autocomplete="off">
      <input style="display:none">
     <input type="password" style="display:none">
     <input placeholder="'.phrase_username.'" name="account" class="login_username" type="text" autocomplete="off"/>
  <input placeholder="'.phrase_password.'" id="password" name="password" class="login_password" type="password" autocomplete="off"/>
