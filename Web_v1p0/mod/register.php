...
<form class='form' id="register" method='post' autocomplete="off">
<table class="table_reg">

                    <tbody>
                      <tr>
                        <td width="30%"><?php echo phrase_username?></td>
                        <td align='left' colspan='3'><input id="username" type='text' name='account' maxlength='10' class='button' onblur='showHint(this.value)' autocomplete="off"><span class='error' id='txtHint'></span></td>
                      </tr>
                      <tr>
                        <td width="30%"><?php echo phrase_password?></td>
                        <td align='left' colspan='2' width="30%">
                            <input id="password" type='password' name='password' maxlength='10' class='button' onKeyUp='checkPassword(this.value)' autocomplete="off">
                       </td>
                       <td width="40%">
                      ...
                      <tr>
                       ...
                       <td align='left'colspan='2' width="30%">
                         <input id="password2" type='password' name='repassword' maxlength='10' class='button' autocomplete="off">
                         </td>
                       </tr>
                        <tr><td height="20px">
                      ...
                      <tr>
                        ...
                        <input type='email' id="email" name='email' maxlength='40' class='button' onblur='showMail(this.value)' autocomplete="off">
                      ...
                      <tr>
                        ...
                        <td align='left'colspan='2' width="30%"><input type='text' name='question' maxlength='20' class='button' placeholder="Optional"></td>
 		
                      </tr>
                      <tr>
                        <td width="30%">&nbsp;&nbsp;<?php echo phrase_answer?></td>
                       <td align='left'colspan='2' width="30%"><input type='text' name='answer' maxlength='20' class='button' placeholder="Optional"></td>
                      </tr>
                        <tr>
